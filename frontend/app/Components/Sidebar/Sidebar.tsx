...
function Sidebar() {
  ...
  const [user, setUser] = useState<{ firstName: string; lastName: string; imageUrl: string }>({
    firstName: "",
    lastName: "",
  ...
  useEffect(() => {
    ...
    if (token) {
      try {
        const decoded = jwt.decode(token) as { firstName?: string; lastName?: string; imageUrl?: string };
        setUser({
          firstName: decoded?.firstName || "",
          lastName: decoded?.lastName || "",
          imageUrl: decoded?.imageUrl || "/default-avatar.png",
        });
      } catch (error) {
